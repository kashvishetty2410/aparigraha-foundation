...
const AboutSection = () => {
  const values = [
    ...
    },
    {
      icon: Target,
      title: "Impact Focus",
      description: "We measure success by the tangible, lasting change we create in communities."
    },
    {
      icon: Users,
      title: "Collaboration",
    ...
    },
    {
      ...
      description: "Our programs are designed to create self-sustaining positive change."
    }
  ];
        ...
        <div className="mb-20">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => (
              <Card key={value.title} className={`program-card fade-in-up stagger-${index + 1}`}>
